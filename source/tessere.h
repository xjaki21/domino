/**
 * @file tessere.h
 * @brief Dichiarazione delle funzioni e le strutture per la gestione di una scacchiera di tessere.
 */
...
typedef struct Tessera{
  ...
  int num;       /**< Numero identificativo della tessera per l'interfaccia utente. */
